...
--    Jobs = ss "Anstellungen" ;
    ...
    ResearchEngineerJob = ss "Research Engineer" ;
    ResearcherJob = ss "Researcher" ;
    Resource_Grammar_Development = ss "Resource grammar development" ;
    SBXCompany = ss "Språkbanken Text, University of Gothenburg";
    ...
    SBXJobDescription = ss "System administration, Federated login and development of corpus quality test framework";
}
