concrete FullCVGer of FullCV = CVGer, FullCVI-[DegreeType] ** open Prelude in {
  lin
    ...
    DemoPresentation = ss "Demonstration" ;
    English = ss "Englisch" ;
...
--    Jobs = ss "Anstellungen" ;
    ...
    SBXJobDescription = ss "Systemadministration, Verteilte Useranmeldung und Entwicklung eines Frameworks zum Testen von Korpusqualität";
}
