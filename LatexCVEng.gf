...
--	    if_then_Str stackoverflow.empty "" ("\\stackoverflow{" ++ stackoverflow.id ++ "}{" ++ stackoverflow.name ++ "}") ++ nl ++
	    ...
	    "%-------------------------------------------------------------------------------" ++ nl ++ 
	    "\\vspace{-10px}" ++ nl ++ 
	    "\\cvsection{University Degrees}" ++ nl ++ nl ++
	    "\\begin{cventries}" ++ nl ++
	    degrees.s ++ nl ++ nl ++
	    "\\end{cventries}" ++ nl ++
	    "\\vspace{-10px}" ++ nl ++ 
	    "\\cvsection{University Edudation}" ++ nl ++ nl ++
	    "\\begin{cventries}" ++ nl ++
	    education.s ++ nl ++
	    "\\end{cventries}" ++ nl ++
	    "\\vspace{-10px}" ++ nl ++ 
	    "\\cvsection{Job Experience}" ++ nl ++ nl ++
	    "\\begin{cventries}" ++ nl ++
	    jobs.s ++ nl ++
	    "\\end{cventries}" ++ nl ++
	    "\\vspace{-10px}" ++ nl ++ 
	    "\\cvsection{Publications}" ++ nl ++ nl ++
	    "\\begin{cvpubs}" ++ nl ++
	    publications.s ++ nl ++ nl ++
	    "\\end{cvpubs}" ++ nl ++
	    "\\vspace{-10px}" ++ nl ++ 
	    "\\cvsection{Presentations}" ++ nl ++ nl ++
	    "\\begin{cvpubs}" ++ nl ++
	    presentations.s ++ nl ++ 
	    "\\end{cvpubs}" ++ nl ++
	    "\\vspace{-10px}" ++ nl ++ 
	    "\\cvsection{Teaching Experience}" ++ nl ++ nl ++
	    "\\begin{cventries}" ++ nl ++
	    teachings.s ++ nl ++
	    "\\end{cventries}" ++ nl ++
	    "\\vspace{-10px}" ++ nl ++ 
	    "\\cvsection{Grants}" ++ nl ++ nl ++
	    "\\begin{cvhonors}" ++ nl ++
	    grants.s ++
	    "\\end{cvhonors}" ++ nl ++
	    "\\vspace{-10px}" ++ nl ++ 
	    ...
	    "\\end{cvhonors}" ++ nl ++
	    "\\vspace{-10px}" ++ nl ++ 
	    "\\cvsection{Conference Involvement}" ++ nl ++ nl ++
	    "\\begin{cvhonors}" ++ nl ++
	    confs.s ++
	    "\\end{cvhonors}" ++ nl ++
	    "\\vspace{-10px}" ++ nl ++ 
	    "\\cvsection{Other Involvement}" ++ nl ++ nl ++
	    "\\begin{cvhonors}" ++ nl ++
	    involvements.s ++
	    "\\end{cvhonors}" ++ nl ++
	    "\\vspace{-10px}" ++ nl ++ 
	    "\\cvsection{Skills}" ++ nl ++ nl ++
	    "Five levels: Basic knowledge (1), Basic experience (2), Professional experience (3), Expert (4),  Guru (5)" ++ nl ++ nl ++
	    skills.s ++
	    "" ++ nl ++ nl ++
	    "%-------------------------------------------------------------------------------" ++ nl ++ 
	    "\\end{document}" ++ nl
    ...
    ProceedingsPublication editors bookTitle publisher address date series volume pages doi status =
      ss (bindSurround "\\cvpub{"
	    (bindSurround "\\emph{" bookTitle.s "}" ++ bindBracket date.s ++ Prelude.BIND ++ ";" ++ editors.s ++ "(eds.)" ++ bindComma' ++
    ...
    NewDegree degree university address date thesisTitle =
      ss ("\\cventry" ++ nl ++
	    ...
	    bindSurround "{Thesis: ``" thesisTitle.s "''}" ++ nl
      );
